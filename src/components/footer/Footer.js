	...
	return (
		<div className='footer'>
			<div className="footer-items">
				...
				<a rel='noopener' target="_blank" aria-label="LinkedIn" href=""><FaTwitter size={30} className="footer-icon twitter" /></a>
				<a rel='noopener' target="_blank" aria-label="LinkedIn" href=""><FaInstagram size={30} className="footer-icon instagram" /></a >
			</div >
